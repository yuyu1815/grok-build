...
pub trait SlashCommand: Send + Sync {
    ...
    /// Usage string shown in help. E.g., `"/models"`.
    fn usage(&self) -> &str;
    ...
    /// spawns, and `/multiline` toggles compose mode on the dashboard inputs.
    /// Those override this to `true` so they appear in the dashboard
