...
pub use paths::{
    ...
    default_auth_path, default_grok_home, encode_cwd_dirname, ensure_sessions_cwd_dir,
    grok_application, grok_application_in, grok_home, selected_auth_path, sessions_cwd_dir,
